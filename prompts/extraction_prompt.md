...
- **Keep every hedge, and never manufacture precision.** "about", "roughly", "I think", "somewhere around" all survive the rewrite, because they are the writer telling you how much to trust the number. A genuinely vague phrase stays vague — "in the seventies" stays "in the seventies", not `70%`, because nobody said seventy. Never round, never average, never resolve an ambiguity the notes left open.
